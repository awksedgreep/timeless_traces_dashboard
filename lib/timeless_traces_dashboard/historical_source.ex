...
defmodule TimelessTracesDashboard.HistoricalSource.DataPlane do
  ...
  defp normalize_stats(stats) when is_map(stats) do
    ...
    %{
      ...
      zstd_blocks: value(stats, :compressed_blocks, 0),
      zstd_bytes: value(stats, :compressed_bytes, total_bytes),
      openzl_blocks: 0,
      openzl_bytes: 0,
      compression_raw_bytes_in: value(stats, :extension_optimize_raw_input_bytes, 0),
      compression_compressed_bytes_out: value(stats, :extension_optimize_raw_output_bytes, 0),
